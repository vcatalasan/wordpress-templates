                ...
                <div class="margin_vertical_10">
                    ...
                    <ul style="overflow:hidden;">
                        <li id="authorizenet_enable_receipt">
                            <input type="checkbox" name="gf_authorizenet_enable_receipt" id="gf_authorizenet_enable_receipt" value="1" <?php echo rgar($config["meta"], 'enable_receipt') ? "checked='checked'"  : "" ?> />
